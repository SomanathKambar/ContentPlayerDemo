 ...
 */
class MyItemRecyclerViewAdapter (private val iOnItemClickHandler: IOnItemClickHandler)
    : RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder>() {
    private lateinit var values: List<MediaItem>
    ...
    fun updateData(value: List<MediaItem>) {
        values = value
